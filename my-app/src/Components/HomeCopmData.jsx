...
export const FeaturedcompaniesactivelyhiringData = [
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/4614431.gif', name: 'Netcracker', rating: '3.7', reviews: '393', dis: 'Global leader in BSS, OSS and cloud.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/21746.gif', name: 'FIS', rating: '4.1', reviews: '3.6K+', dis: 'FIS is hiring 3 to 10yrs exp. in C++ & Mumps developer.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/4264.gif', name: 'WNS Holdings', rating: '3.7', reviews: '7K+', dis: 'Leading business process management company.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/1186200.gif', name: 'Virtusa', rating: '3.8', reviews: '2.2K+', dis: 'IT services company since 1996.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/4654342.gif', name: 'Cnts', rating: '4.4', reviews: '36', dis: 'Leading technology provider.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/18850.gif', name: 'Oracle', rating: '3.9', reviews: '4K+', dis: 'Cloud technology company since 1977.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/233334.gif', name: 'Coforge', rating: '3.8', reviews: '1K+', dis: 'Global digital services and solutions provider.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/44512.gif', name: 'ICICI Bank', rating: '4.0', reviews: '35K+', dis: 'Leading private sector bank in India.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/3835862.gif', name: 'Persistent', rating: '4.1', reviews: '1.6K+', dis: 'Trusted global solutions company.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/4577755.gif', name: 'Accolite Digital', rating: '3.9', reviews: '317', dis: 'Digital transformation services provider.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/42932.gif', name: 'Genpact', rating: '4.0', reviews: '21.1K+', dis: 'Global professional services firm.' },
    { pic: 'https://img.naukimg.com/logo_images/groups/v2/240936.gif', name: 'JPMorgan Chase Bank', rating: '4.2', reviews: '3.6K+', dis: 'Leader in financial services.' },
]

export const HalfSliderData = [
    {
        arr: [
            { name: 'Full Stack Developer', jobs: '20.4K+' },
            { name: 'Mobile / App Deve..', jobs: '2.4K+' },
            { name: 'Front End Developer', jobs: '3.1K+' },
            { name: 'DevOps Engineer', jobs: '1.7K+' },
            { name: 'Engineering Manager', jobs: '912' },
            { name: 'Technical Lead', jobs: '11.1K+' },
        ]
    },
    {
        arr: [
            { name: 'Automation Test Engi...', jobs: '2K+' },
            { name: 'Cyber Security', jobs: '399' },
            { name: 'Technical Architech', jobs: '7.5K+' },
            { name: 'Business Analyst', jobs: '5.2K+' },
            { name: 'Data Scientist', jobs: '718' },
            { name: 'Program Manager - T...', jobs: '660' },
        ]
    },
    {
        arr: [
            { name: 'Product Manager', jobs: '2.5K+' },
            { name: 'UI / UX Designer', jobs: '913' },
            { name: 'Research Analyst', jobs: '229' },
            { name: 'Branch Manager', jobs: '1.2K+' },
            { name: 'Functional Consultant', jobs: '2.9K+' },
            { name: 'Charted Accountant', jobs: '1.4K+' },
        ]
    },
...
export const HomelastSliderData = [
    { sector: 'Data Science', name: 'Artificial Intelligence', dis: 'Learn in demand AI skills like Deep learning, NLP, Computer vision and more for career growth across different roles.', btn1: '600', btn2: '28' },
    { sector: 'Cloud Technologies', name: 'AWS', dis: 'Get certified for high demand cloud computing skills for Cloud Practitioner, Architect, Developer, and Operations roles.', btn1: '800', btn2: '16' },
    { sector: 'Programming', name: 'Data Structures & Algo..', dis: 'Master DS and Algorithms for entry level engineering roles in product companies and for competitive programming.', btn1: '800', btn2: '13' },
    { sector: 'Management', name: 'Strategy and Leadership', dis: 'Learn to lead and thrive in a world of increasing uncertainty and volatility - get certified from top universities.', btn1: '500', btn2: '70' },
    { sector: 'Management', name: 'Digital Marketing', dis: 'A fast growing field with opportunities in PPC, SEO, Email marketing, Marketing analytics, Content marketing and more.', btn1: '700', btn2: '25' },
